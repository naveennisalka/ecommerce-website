...
<div class="modal-overlay" id="assign-modal">
  ...
  <div class="modal-box" style="position:relative;z-index:1;">
    <div class="modal-header">
      <h3><span class="material-symbols-outlined">two_wheeler</span> Assign Delivery Man</h3>
      <button class="modal-close" onclick="closeAssignModal()"><span class="material-symbols-outlined" style="font-size:inherit; vertical-align:middle;">close</span></button>
    </div>
  ...
  <nav class="sidebar-nav">
    <div class="sidebar-nav-section">
      ...
      <a class="sidebar-nav-item" data-tab="orders" href="#" onclick="switchTab('orders');return false;">
        <span class="sidebar-nav-icon"><span class="material-symbols-outlined">inventory_2</span></span> Incoming Orders
      ...
      <a class="sidebar-nav-item" data-tab="products" href="#" onclick="switchTab('products');return false;">
        <span class="sidebar-nav-icon"><span class="material-symbols-outlined">restaurant</span></span> My Products
      ...
      <a href="add_product.php" class="sidebar-nav-item">
        <span class="sidebar-nav-icon"><span class="material-symbols-outlined">add</span></span> Add Product
      </a>
...
<div class="dashboard-main">
  ...
  <div class="dashboard-content">
    ...
    <div class="stats-grid">
      <div class="stat-card">
        <div class="stat-card-top"><div class="stat-icon orange"><span class="material-symbols-outlined">inventory_2</span></div><span class="stat-trend"><?= count($orders) ?> total</span></div>
      ...
      <div class="stat-card">
        <div class="stat-card-top"><div class="stat-icon blue"><span class="material-symbols-outlined">restaurant</span></div></div>
    ...
    <div id="tab-orders" class="tab-panel">
      <div class="data-table-wrap">
        ...
        <table class="data-table">
          ...
          <tr>
            ...
            <td>
              ...
              <div style="font-size:.75rem;color:var(--text-muted);"><span class="material-symbols-outlined">call</span> <?= htmlspecialchars($ord['customer_phone']??'') ?></div>
            ...
            <td>
              ...
              <?php if ($ord['status']==='pending'): ?>
                <button onclick="updateOrderStatus(<?= $ord['id'] ?>,'confirmed','Shop confirmed the order')" class="btn-primary" style="font-size:.72rem;padding:5px 10px;"><span class="material-symbols-outlined">check_circle</span> Confirm</button>
              <?php endif; ?>
              <?php if (in_array($ord['status'],['confirmed','preparing']) && !$ord['delivery_man_id']): ?>
                <button onclick="openAssignModal(<?= $ord['id'] ?>)" class="btn-outline" style="font-size:.72rem;padding:5px 10px;"><span class="material-symbols-outlined">two_wheeler</span> Assign Rider</button>
              <?php endif; ?>
              ...
              <?php endif; ?>
              <?php if ($ord['status']==='pending'): ?>
                <button onclick="updateOrderStatus(<?= $ord['id'] ?>,'cancelled','Cancelled by shop')" style="font-size:.72rem;padding:5px 10px;background:#FFF0F0;color:#E8001C;border:1px solid #FADADD;border-radius:6px;cursor:pointer;"><span class="material-symbols-outlined" style="font-size:inherit; vertical-align:middle;">close</span> Cancel</button>
              <?php endif; ?>
              </div>
            </td>
          </tr>
        ...
        <div class="empty-state"><div class="empty-icon"><span class="material-symbols-outlined">check_circle</span></div><h3>No completed orders</h3><p>Delivered and cancelled orders will appear here.</p></div>
        <?php else: ?>
        <table class="data-table">
    ...
    <div id="tab-products" class="tab-panel" style="display:none;">
      ...
      <div class="empty-state"><div class="empty-icon"><span class="material-symbols-outlined">restaurant</span></div><h3>No products listed</h3><p>Add your first product to start receiving orders.</p><a href="add_product.php" class="btn-primary" style="margin-top:16px;display:inline-flex;">+ Add Product</a></div>
      <?php else: ?>
      <div class="data-table-wrap">
        <table class="data-table">
    ...
    <div id="tab-notifications" class="tab-panel" style="display:none;">
      ...
      <div class="notif-list">
        ...
        <div class="notif-item <?= $n['is_read']?'':'unread' ?>" data-id="<?= $n['id'] ?>">
          <div class="notif-icon <?= $n['type'] ?>"><?= $n['type']==='order'?'<span class="material-symbols-outlined">inventory_2</span>':'<span class="material-symbols-outlined">notifications</span>' ?></div>
